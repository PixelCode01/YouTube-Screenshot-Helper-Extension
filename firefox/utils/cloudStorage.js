...
class CloudStorageManager {
  ...
  async authenticateGoogleDrive({ interactive = true } = {}) {
    ...
    if (!browser.identity || typeof browser.identity.launchWebAuthFlow !== 'function') {
      throw new Error('Google Drive authentication is not available in this browser yet. Please use Simple Cloud or local downloads.');
    }
  ...
  async authenticateOneDrive({ interactive = true } = {}) {
    ...
    if (!browser.identity || typeof browser.identity.launchWebAuthFlow !== 'function') {
      throw new Error('OneDrive authentication is not available in this browser yet. Please use Simple Cloud or local downloads.');
    }
